...
import (
	...
	"github.com/rtalhouk/paho.golang/autopaho/queue"
	"github.com/rtalhouk/paho.golang/autopaho/queue/memory"
...
// AutoPaho is a wrapper around github.com/rtalhouk/paho.golang that simplifies the connection process; it automates
...
// requirements differ then please consider using github.com/rtalhouk/paho.golang directly (perhaps using the
		...
		for {
			...
			for {
				...
				if errors.Is(err, queue.ErrEmpty) {
					...
					// see https://github.com/rtalhouk/paho.golang/issues/234
